...
model.add(Convolution2D(32, 3, 3, border_mode='same',
                        input_shape=X_train.shape[1:], init = "orthogonal"))
...
model.add(Convolution2D(64, 3, 3, border_mode='same', init = "orthogonal"))
model.add(Activation('relu'))
model.add(Convolution2D(64, 3, 3, init = "orthogonal"))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Dropout(0.25))
